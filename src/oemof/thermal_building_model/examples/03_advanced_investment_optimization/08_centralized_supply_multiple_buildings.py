...
def run_main(heat_grid_temperature):
    ...
    if True:
        ...
        co2_reduction_factors =  [1,0.95,0.85,0.75,0.65,0.55,0.45,0.35,0.25,0.15,0.05,0.01,-0.01,-0.05,-0.1,-0.2] # [0.95,0.9,0.85,0.8,0.75,0.7,0.65,0.6,0.5] [0.9,0.8,0.7,0.6,0.5,0.4,0.3,0.2,0.1]
        ...
        for co2_reduction_factor in co2_reduction_factors:
            ...
            peak_reduction_factors = [1,0.95,0.85,0.75,0.65,0.55,0.45,0.35,0.25,0.15,0.05]
            ...
            file_path = "rrrresults_heat_grid_"+str(heat_grid_temperature)+"_"+str(ueu)+"_" + str(ev) +".pkl"
...
if __name__ == "__main__":
    ...
    for heat_grid_temperature in heat_grid_supply_temperatures:
        ...
        #except:
        #    print("start: "+str(heat_grid_temperature))
    if False:
