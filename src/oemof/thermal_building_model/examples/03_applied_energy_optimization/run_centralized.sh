...
# Shared settings for distributed centralized runs.
...
EOF
  ...
  echo "Launching on $host: workers=$workers sfh_k=$sfh_k mfh_k=$mfh_k scenario_mode=$SCENARIO_MODE temps=$TEMPS ueu=$UEU_CASES result_storage_root=$RESULT_STORAGE_ROOT"
