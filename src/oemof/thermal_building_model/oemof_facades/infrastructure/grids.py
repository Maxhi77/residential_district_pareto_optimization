...
class Grid:
    ...
    def post_process(self,
        ...
        return {"capacity":capacity,
                ...
                "flow_from_grid_sum":sum(flow_from_grid) if flow_from_grid is not None else None,
                "flow_into_grid_sum": sum(flow_into_grid)if flow_into_grid is not None else None,
...
class GasGrid(Grid):
    ...
    operation_grid: GridComponents = field(default_factory=lambda: copy.deepcopy(natural_gas_grid_config))
